...
def generator_model():
	...
	#1x1
	deconv0 = Deconvolution2D(256,3,3,border_mode='same',init='he_normal',subsample=(2,2),output_shape=(generated_images.shape[0],256,2,2))(conv5)
	...
	deconv1 = Deconvolution2D(128,3,3,subsample=(2,2),border_mode='same',init='he_normal',output_shape=(generated_images.shape[0],128,4,4))(deconv0)
	...
	deconv2 = Deconvolution2D(64,3,3,subsample=(2,2),border_mode='same',init='he_normal',output_shape=(generated_images.shape[0],64,8,8))(m1)
	deconv2 = BatchNormalization(mode=2,axis=1)(deconv2)
	deconv2 = Activation('relu')(deconv2)
	# 8x8
	m2 = merge([deconv2,conv2],mode='concat',concat_axis=1)

	deconv3 = Deconvolution2D(32,3,3,subsample=(2,2),border_mode='same',init='he_normal',output_shape=(generated_images.shape[0],32,16,16))(m2)
	...
	deconv4 = Deconvolution2D(32,3,3,subsample=(2,2),border_mode='same',init='he_normal',output_shape=(generated_images.shape[0],32,32,32))(m3)
