...
def rgb2yuv(rgb):
	return numpy.dot([[0.299,0.587,0.114],[-0.14713,-0.28886,0.436],[0.615,-0.51499,-0.10001]],rgb)
...
for i in range(7,len(cifar10_Classes)):
	...
	Y_yuv_test = numpy.zeros((Y_rgb_test.shape[0],Y_rgb_test.shape[1],Y_rgb_test.shape[2],Y_rgb_test.shape[3]))
